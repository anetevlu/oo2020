...
public class PunktmassiPaar extends AbstraktnePunktmass{
    ...
    public PunktmassiPaar(
       AbstraktnePunktmass up1, AbstraktnePunktmass up2){
        p1=up1; p2=up2;
    }
    ...
    public void joonista(Graphics g, int sygavus){
        ...
        g.drawLine((int)(p1.massikeseX()*KOEFX), (int)(SYGAVUSPX*(sygavus+1)),
                   (int)(p2.massikeseX()*KOEFX), (int)(SYGAVUSPX*(sygavus+1)));

        g.drawLine((int)(p1.massikeseX()*KOEFX), (int)(SYGAVUSPX*(sygavus+1)),
                   (int)(p1.massikeseX()*KOEFX), (int)(SYGAVUSPX*(sygavus+2)));

        g.drawLine((int)(p2.massikeseX()*KOEFX), (int)(SYGAVUSPX*(sygavus+1)),
                   (int)(p2.massikeseX()*KOEFX), (int)(SYGAVUSPX*(sygavus+2)));
